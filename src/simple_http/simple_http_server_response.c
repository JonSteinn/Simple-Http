...
void init_default_responses(Server* server) {
    ...
    g_hash_table_insert(server->default_response, alloc_int(100), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(101), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(102), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(103), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(200), g_string_new(
        "HTTP/1.1 200 OK\r\n"
        "Content-Type: text/html; charset=\"utf-8\"\r\n"
        "Content-Length: 81\r\n\r\n"
    ...
    g_hash_table_insert(server->default_response, alloc_int(201), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(202), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(203), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(204), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(205), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(206), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(207), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(208), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(226), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(300), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(301), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(302), g_string_new(
        "HTTP/1.1 302 Found\r\n"
        "Content-Type: text/html; charset=\"utf-8\"\r\n"
        "Content-Length: 87\r\n\r\n"
    ...
    g_hash_table_insert(server->default_response, alloc_int(303), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(304), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(305), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(306), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(307), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(308), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(400), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(401), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(402), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(403), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(404), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(405), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(406), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(407), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(408), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(409), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(410), g_string_new(
        "HTTP/1.1 410 Gone\r\n"
        "Content-Type: text/html; charset=\"utf-8\"\r\n"
        "Content-Length: 85\r\n\r\n"
    ...
    g_hash_table_insert(server->default_response, alloc_int(411), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(412), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(413), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(414), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(415), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(416), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(417), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(418), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(421), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(422), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(423), g_string_new(
        "HTTP/1.1 423 Locked\r\n"
        "Content-Type: text/html; charset=\"utf-8\"\r\n"
        "Content-Length: 89\r\n\r\n"
    ...
    g_hash_table_insert(server->default_response, alloc_int(424), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(426), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(428), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(429), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(431), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(451), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(500), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(501), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(502), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(503), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(504), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(505), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(506), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(507), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(508), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(510), g_string_new(
    ...
    g_hash_table_insert(server->default_response, alloc_int(511), g_string_new(
